...
def signup():
    ...
    # create connection
    connection = pymysql.connect(host="localhost", user="root", password="", database="marani_sokogarden")
    ...
    # return response
    return jsonify({"mesage": "Sign up successfull"})
...
def login():
    ...
    # cursor to fetch data as key-value pair
    ...
    return jsonify({"message": "loged in successfully"})      
...
def add_product():
    ...
    print(product_category, product_cost, product_description, product_image, product_name)
    ...
    return jsonify({"message": "Product addes successfully"})
